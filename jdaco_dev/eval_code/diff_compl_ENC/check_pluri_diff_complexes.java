...
public class check_pluri_diff_complexes {
	...
	public static void main(String[] args) {
		...
		dsvd.diffTFComplAnalysis(pluri_definitions.diff_tfc_output_folder, pluri_definitions.goa, pluri_definitions.binding_data, 0.0001, pluri_definitions.d_min, pluri_definitions.d_max, true, allosome_proteins, pluri_definitions.pluri_factors);
		...
		tf_enrich.writeSignificantSeedProteins(pluri_definitions.diff_tfc_output_folder + "enriched_pos_TFs.txt", pluri_definitions.diff_tfc_output_folder + "enriched_neg_TFs.txt");
		...
		dcd.diffTFComplAnalysis(pluri_definitions.diff_complex_output_folder, pluri_definitions.goa, pluri_definitions.binding_data, 0.0001, pluri_definitions.d_min, pluri_definitions.d_max, true, allosome_proteins, pluri_definitions.pluri_factors);
		...
		tfc_enrich.writeSignificantSeedProteinCombinations(pluri_definitions.diff_complex_output_folder + "enriched_pos_TFCs.txt", pluri_definitions.diff_complex_output_folder + "enriched_neg_TFCs.txt");
		...
		tf_enrich2.writeSignificantSeedProteins(pluri_definitions.diff_complex_output_folder + "enriched_pos_TFs.txt", pluri_definitions.diff_complex_output_folder + "enriched_neg_TFs.txt");
	}
}
