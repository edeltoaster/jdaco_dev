...
public class check_MCF7_diff_complexes {
	...
	public static void main(String[] args) {
		...
		dsvd.diffTFComplAnalysis(pluri_definitions.diff_tfc_output_folder, pluri_definitions.goa, pluri_definitions.binding_data, 0.0001, pluri_definitions.d_min, pluri_definitions.d_max, true, null, null);
		...
		dcd.diffTFComplAnalysis(pluri_definitions.diff_complex_output_folder, pluri_definitions.goa, pluri_definitions.binding_data, 0.0001, pluri_definitions.d_min, pluri_definitions.d_max, true, null, null);
