...
public class check_pluri_diffcomplexes {
	...
	public static void main(String[] args) {
		...
		DiffComplexDetector dcd = new DiffComplexDetector(group1, group2, definitions.qvalue, definitions.parametric, false, definitions.check_supersets, definitions.no_threads);
