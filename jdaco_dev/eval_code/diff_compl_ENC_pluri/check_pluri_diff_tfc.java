...
public class check_pluri_diff_tfc {
	...
	public static void main(String[] args) {
		...
		dsvd.diffTFComplAnalysis(definitions.diff_compl_output_folder, definitions.goa, definitions.binding_data, 0.0001, definitions.d_min, definitions.d_max, true, allosome_proteins);
