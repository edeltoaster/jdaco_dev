...
/*
 * here, transcript abundances are randomized before QDRs approximations is applied
 */
public class test_abundance_estimation_rnd {
	...
	/**
	 * Modify transcript map in place
	 * @param map
	 */
	public static void shuffleTranscriptAbundances(Map<String, Float> map) {
	 ...
	 * @return
	 */
	public static Object[] simulate_sample_model_tr(String daco_outfile, String major_transcript_file, double std_factor, double remaining_prefactor) {
		...
		// randomizes transcript abundance mapping
		shuffleTranscriptAbundances(transcript_abundance);
	 ...
	 * @return
	 */
	public static double[] simulate_sample_model_run_tr(String daco_result_file, String major_transcripts_file, double std_factor, double remaining_prefactor, int iteration, List<String> sample_construction_outputs) {
		
		// get results of simulation
		Object[] simulation = simulate_sample_model_tr(daco_result_file, major_transcripts_file, std_factor, remaining_prefactor);
	 ...
	 */
	public static void benchmark_tr() {
		...
		for (double std:stds)
			for (double prefactor:prefactors) {
				...
				for (Entry<String, String> sample : data.entrySet()) {
					ForkJoinTask<List<double[]>> task = pool.submit(() -> IntStream.range(0, no_iterations).boxed().parallel().map(d -> simulate_sample_model_run_tr(sample.getKey(), sample.getValue(), std, prefactor, d, sample_construction_outputs)).collect(Collectors.toList()));
				...
				Utilities.writeEntries(all_iterations, "perf_all_iterations_rnd_tr.txt.gz");
				Utilities.writeEntries(sample_construction, "sample_construction_rnd_tr.txt.gz");
			}
	 ...
	 * @return
	 */
	public static Object[] simulate_sample_model2_tr(String daco_outfile, String major_transcript_file, double remaining_prefactor) {
		// load real complex result
		QuantDACOResultSet dr = new QuantDACOResultSet(daco_outfile, "mixed_data/hocomoco_human_TFs_v10.txt.gz", major_transcript_file);
		List<HashSet<String>> complexes = new ArrayList<>(dr.getResult());
		List<Float> tr_abundance_values = new ArrayList<>(dr.getTranscriptAbundance().values());
	 ...
	 * @return
	 */
	public static double[] simulate_sample_model_run2_tr(String daco_result_file, String major_transcripts_file, double remaining_prefactor, int iteration, List<String> sample_construction_outputs) {
		
		// get results of simulation
		Object[] simulation = simulate_sample_model2_tr(daco_result_file, major_transcripts_file, remaining_prefactor);
		QuantDACOResultSet qdr = (QuantDACOResultSet) simulation[0];
		@SuppressWarnings("unchecked")
		Map<HashSet<String>, Double> artificial_complex_abundance = (Map<HashSet<String>, Double>) simulation[1];
		@SuppressWarnings("unchecked")
	 ...
	 */
	public static void benchmark2_tr() {
		...
		for (double prefactor:prefactors) {
			...
			for (Entry<String, String> sample : data.entrySet()) {
				ForkJoinTask<List<double[]>> task = pool.submit(() -> IntStream.range(0, no_iterations).boxed().parallel().map(d -> simulate_sample_model_run2_tr(sample.getKey(), sample.getValue(), prefactor, d, sample_construction_outputs)).collect(Collectors.toList()));
				tasks.put(sample.getKey(), task);
			}
			...
			// already write something
			Utilities.writeEntries(all_iterations, "perf_all_iterations_rnd_tr2.txt.gz");
			Utilities.writeEntries(sample_construction, "sample_construction_rnd_tr2.txt.gz");
		}
	 ...
	 * @return
	 */
	public static Object[] simulate_sample_model3_tr(String daco_outfile, String major_transcript_file, double remaining_prefactor) {
		// load real complex result
		QuantDACOResultSet dr = new QuantDACOResultSet(daco_outfile, "mixed_data/hocomoco_human_TFs_v10.txt.gz", major_transcript_file);
		List<HashSet<String>> complexes = new ArrayList<>(dr.getResult());
		List<Float> tr_abundance_values = new ArrayList<>(dr.getTranscriptAbundance().values());
	 ...
	 * @return
	 */
	public static double[] simulate_sample_model_run3_tr(String daco_result_file, String major_transcripts_file, double remaining_prefactor, int iteration, List<String> sample_construction_outputs) {
		
		// get results of simulation
		Object[] simulation = simulate_sample_model3_tr(daco_result_file, major_transcripts_file, remaining_prefactor);
		QuantDACOResultSet qdr = (QuantDACOResultSet) simulation[0];
		@SuppressWarnings("unchecked")
		Map<HashSet<String>, Double> artificial_complex_abundance = (Map<HashSet<String>, Double>) simulation[1];
		@SuppressWarnings("unchecked")
	 ...
	 * Tests prediction on real data, uses real distributions
	 */
	public static void benchmark3_tr() {
		...
		for (double prefactor:prefactors) {
			...
			for (Entry<String, String> sample : data.entrySet()) {
				ForkJoinTask<List<double[]>> task = pool.submit(() -> IntStream.range(0, no_iterations).boxed().parallel().map(d -> simulate_sample_model_run3_tr(sample.getKey(), sample.getValue(), prefactor, d, sample_construction_outputs)).collect(Collectors.toList()));
				tasks.put(sample.getKey(), task);
			}
			...
			// already write something
			Utilities.writeEntries(all_iterations, "perf_all_iterations_rnd_tr3.txt.gz");
			Utilities.writeEntries(sample_construction, "sample_construction_rnd_tr3.txt.gz");
		}
	...
	public static double[] simulate_sample_model_run(String daco_result_file, String major_transcripts_file, double std_factor, double remaining_prefactor, int iteration, List<String> sample_construction_outputs) {
		...
		// shuffle
		Collections.shuffle(evaluated, rnd);
		Collections.shuffle(rem_evaluated, rnd);
	...
	public static void benchmark() {
		...
		for (double std:stds)
			for (double prefactor:prefactors) {
				...
				// already write something
				Utilities.writeEntries(all_iterations, "perf_all_iterations_rnd.txt.gz");
				Utilities.writeEntries(sample_construction, "sample_construction_rnd.txt.gz");
			}
	...
	public static void benchmark2() {
		...
		for (double prefactor:prefactors) {
			...
			// already write something
			Utilities.writeEntries(all_iterations, "perf_all_iterations_rnd2.txt.gz");
			Utilities.writeEntries(sample_construction, "sample_construction_rnd2.txt.gz");
		}
	...
	public static void benchmark3() {
		...
		for (double prefactor:prefactors) {
			...
			// already write something
			Utilities.writeEntries(all_iterations, "perf_all_iterations_rnd3.txt.gz");
			Utilities.writeEntries(sample_construction, "sample_construction_rnd3.txt.gz");
		}
