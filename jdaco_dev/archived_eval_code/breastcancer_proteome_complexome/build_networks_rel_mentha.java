...
public class build_networks_rel_mentha {
	static String expr_folder = "/Users/tho/GDrive/Work/projects/breastcancer_proteome_complexomes/rel_abundances/";
	...
	public static void process() {
		...
		for (File f:Utilities.getAllSuffixMatchingFilesInSubfolders(expr_folder, ".txt.gz")) {
			...
			cn.writeProteinToAssumedTranscriptMap(network_folder + file_name + "_major-transcripts_rel.txt.gz");
