...
public class eval_EP300 {
	...
	static Map<String, Double> pluri = readBED("/Users/tho/GDrive/Work/data_general/ENCODE_and_ROADMAP/EP300/pluri_avg.bed.gz");
	static Map<String, Double> nonpluri = readBED("/Users/tho/GDrive/Work/data_general/ENCODE_and_ROADMAP/EP300/nonpluri_max.bed.gz");
	...
	public static void main(String[] args) {
		...
		System.out.println(pluri_Hac_upCs.size() + " P300 Hac complexes in up");
		...
		System.out.println(pluri_Hac_downCs.size() + " P300 Hac complexes in down");
		...
		for (String target : P300_targets) {
			String P300_size = "0";
			...
			to_write.add(target + " " + P300_size + P300_complexes);
		}
		Utilities.writeEntries(to_write, "/Users/tho/Desktop/EP300_region_complex_mapping.txt");
	}
