...
public class retrieve_annotation_data {
	...
	public static void main(String[] args) {
		...
		temp = DataQuery.getProteinsWithGO("GO:0001525", human, include_IEA, true, false);
		...
		temp = DataQuery.getProteinsWithGO("GO:0032202", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0000723", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0090398", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0090399", human, include_IEA, true, false));
...
//		 Activating Invasion and Metastasis	 GO:0007155	 cell adhesion
		...
		temp = DataQuery.getProteinsWithGO("GO:0045216", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0034329", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0045217", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0034334", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0016477", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0010718", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0007155", human, include_IEA, true, false));
...
//		 Genome Instability and Mutation	 GO:0031577	 spindle checkpoint
		...
		temp = DataQuery.getProteinsWithGO("GO:0006281", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0051383", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0007062", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0000819", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0051988", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0030997", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0046605", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0060236", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0090169", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0043146", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0031577", human, include_IEA, true, false));
...
//		 Resisting Cell Death	 GO:0010941	 regulation of cell death
		...
		temp = DataQuery.getProteinsWithGO("GO:0060548", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0012501", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0010941", human, include_IEA, true, false));
...
//		 Deregulating Cellular Energetics	 GO:0006091	 generation of precursor metabolites and energy
		...
		temp = DataQuery.getProteinsWithGO("GO:0006091", human, include_IEA, true, false);
...
//		 Sustaining Proliferative Signaling	 GO:0070848	 response to growth factor
		...
		temp = DataQuery.getProteinsWithGO("GO:0007166", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0070848", human, include_IEA, true, false));
...
//		 Tumor-Promoting Inflammation	 GO:0045321	 leukocyte activation
		...
		temp = DataQuery.getProteinsWithGO("GO:0006954", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0045321", human, include_IEA, true, false));
...
//		 Avoiding Immune Destruction	 GO:0002767	 immune response-inhibiting cell surface receptor signaling pathway
		...
		temp = DataQuery.getProteinsWithGO("GO:0002507", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0001910", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0019882", human, include_IEA, true, false));
		temp.addAll(DataQuery.getProteinsWithGO("GO:0002767", human, include_IEA, true, false));
...
//		 Evading Growth Suppressors	 GO:0008283	 cell proliferation
		...
		temp = DataQuery.getProteinsWithGO("GO:0007049", human, include_IEA, true, false);
		temp.addAll(DataQuery.getProteinsWithGO("GO:0008283", human, include_IEA, true, false));
		annotation_map.put("Evading Growth Suppressors", temp);
		
		
		// other terms
		System.out.println("other terms");
		temp = DataQuery.getProteinsWithGO("GO:0005739", human, include_IEA, true, false);
		annotation_map.put("Mitochondrion", temp);
		temp = DataQuery.getProteinsWithGO("GO:0016491", human, include_IEA, true, false);
		annotation_map.put("Oxidoreductase activity", temp);
		temp = DataQuery.getProteinsWithGO("GO:0016209", human, include_IEA, true, false);
		annotation_map.put("Antioxidant activity", temp);
		temp = DataQuery.getProteinsWithGO("GO:0015085", human, include_IEA, true, false);
