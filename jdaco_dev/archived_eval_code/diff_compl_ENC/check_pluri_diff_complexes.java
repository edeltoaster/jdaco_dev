...
public class check_pluri_diff_complexes {
	...
	public static void main(String[] args) {
		...
		dcd.writeSignSortedComplexes(pluri_definitions.output_folder_pre + "compl/pluri_signh.txt", true);
		...
		dcd.writeSignSortedComplexes(pluri_definitions.output_folder_pre + "compl_sub/pluri_signh.txt", true);
